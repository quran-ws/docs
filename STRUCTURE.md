...
│   │   └── reference/                 # standard.md, decisions.md (prose); dictionary.md, registries.md (generated)
...
- **الصفحة النثرية** (المدخل، والرخصة، والمعيار، وسجل القرارات) ملف في كل لغة، والموجود في لغة واحدة نقص معروف.
