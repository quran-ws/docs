...
تجمع هذه الصفحة ما يحتاجه المطور، ويعرض [معيار تسمية المفردات القرآنية](/guidelines/ar/reference/standard/)
قواعد اختيار الأسماء وتهجئتها وتركيبها والتمييز بينها، مرتبة حسب الموضوع.
لكل قاعدة رقم واسم ووصف وأمثلة.
...
يمكن للمشروع الاحتفاظ بمفاهيمه الخاصة في مجلد مفاهيم بجانب مجلد المعيار، إذا كان تعريفها لا يستند إلى القرآن أو المصحف ([النسخة السابقة، القسم 30](https://github.com/quran-ws/docs/blob/79e3c6bb2b52dd1df81b3e64debfebf9dd5f8ea5/content/ar/reference/standard.md#L1700)).
...
قواعد الاشتقاق في [القواعد 009–036](/guidelines/ar/reference/standard/#rule-009)، وتحتاج إليها فقط عند إضافة اسم، أما استخدام اسم موجود فلا يتطلب معرفتها.
...
*يفحصه:* يكشف الفحص استخدام اللاحقتين `index` و`idx`، أما اختيار اللاحقة المناسبة من اللواحق الـ4 فيلتزم فيه الكاتب بقاعدة المعيار ([القواعد 067–071](/guidelines/ar/reference/standard/#rule-067)).
...
*يفحصه:* يبلغ الفحص عن اللاحقة `type` على مفهوم قرآني ([القاعدة 050](/guidelines/ar/reference/standard/#rule-050)).
