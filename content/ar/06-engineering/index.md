...
- المصحف والتسجيل والـ`dataset` تُربط بالرواية، ولا تُربط بشخص الراوي. فالعمود
  `riwayah_id`، ويوضع `rawi_id` في صف الرواية. وفي قاعدة الكود المفحوصة كان
...
- نمط الأداء يخزن في `recitation_style`، وتقطيع الصوت صفة في الملفات وليس صفة
  في التلاوة. وفي قاعدة الكود المفحوصة جدول اسمه `recitation_types` يحمل «مرتل»
...
- قاعدة الكود المفحوصة سمت مفهومًا واحدًا بـ3 صور: تهجئة مبتورة في النموذج،
