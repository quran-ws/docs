...
أسماء الحروف الـ28 مسجلة في `standards/terminology/data/letter_names.tsv`، وتقرؤها الدالة من ذلك الملف. وسبب القاعدة وقياسها في [سجل القرارات](/guidelines/ar/reference/decisions/).
...
> **مفتوح:** اشتراك حرفين في اسم واحد بعد جمع المفخم والمرقق، ولا يستعمله مدخل اليوم. المسألة في [سجل القرارات](/guidelines/ar/reference/decisions/).
...
هذه الأسماء مسجلة في `standards/terminology/data/established_spellings.tsv`، ومع كل سطر قياسه. ولا نقبل سطرًا جديدًا إلا ومعه قياس يثبت أن الصورة المشتقة لا تكاد تستعمل. ولا يكفي أن يكون الاستعمال راجحًا فقط، وإلا لدخل `tajweed` في هذا الملف. والقياسات في [سجل القرارات](/guidelines/ar/reference/decisions/).
...
وتعرض السجلات في صفحة خاصة بها: [السجلات](/guidelines/ar/reference/registries/).
...
فبث التلاوة بث كأي بث، والفتوى من علوم الإسلام وليست مفهومًا من مفاهيم النص القرآني، والكتاب له اسمه في اللغة. ونقول ذلك صراحة لأن المشروع يبقى محتاجًا إلى أسماء لكتبه ووسومه، والمعيار لا يعطيه إياها. وسبب هذا الحد والبديل المرفوض في [سجل القرارات](/guidelines/ar/reference/decisions/).
