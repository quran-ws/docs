...
| [`madd`](#madd) | Madd | المد | <span dir="ltr">`classification`</span> | <span dir="ltr">`tajwid`</span> | المد إطالة الصوت بحرف من حروف المد الثلاثة، وهي الألف الساكنة بعد فتح والواو الساكنة بعد ضم والياء الساكنة بعد كسر. |
...
**التعريف:** السجدة موضع من مواضع سجود التلاوة في القرآن، ينتهي بآية بعينها، يسجد عنده القارئ والسامع. والسجدات معدودة، خمس عشرة على المشهور، والعلماء يختلفون في عد بعضها.
...
**الغرض:** نستخدمها حيث يهم الترميز الدقيق للمحرف أو العلامة، مثل قواعد التطبيع ومقابلات الخطوط وقائمة النقاط المسموح بها.
...
**الغرض:** نستخدمها لتحديد حدود الآية في النص المكتوب، فمنها يقرأ المحلل والعارض نهاية الآية ورقمها.
...
**الغرض:** نستخدمه أبًا لصور النقط، وما يميز هذه الصور هو عدد النقط وموضعها وليس وظيفتها.
...
**الغرض:** نستخدم التنوين أبًا لعلامات التنوين الثلاث، حتى تجتمع في قائمة واحدة بدل تفريقها.
...
> الطرق الأربعة التي تخزنها التطبيقات، وهي الشاطبية وطيبة النشر والدرة والتيسير، مسجلة في `registries/tariq.tsv`. أما حصر طرق النشر كلها، وعددها نحو 980 طريقًا، فلا يزال مفتوحًا.
...
**الغرض:** نستخدمه لوصف ميزة مستقلة في التسجيل التعليمي بدلًا من جعلها جزءًا ضمنيًا من `muallim`.
...
**التعريف:** الإخفاء هو النطق بالحرف الساكن على صفة بين الإظهار والإدغام، دون تشديد ومع بقاء الغنة. ويكون حقيقيًّا في النون الساكنة والتنوين عند حروفه الخمسة عشر، وشفويًّا في الميم الساكنة عند الباء.
...
**التعريف:** المد إطالة الصوت بحرف من حروف المد الثلاثة، وهي الألف الساكنة بعد فتح والواو الساكنة بعد ضم والياء الساكنة بعد كسر. ويكون المد أصليًّا لا يقوم الحرف إلا به، أو فرعيًّا بسبب همز أو سكون.
...
**الغرض:** نستخدمها موضعًا تتفرع عليه الأحكام الشفوية الثلاثة في محركات التجويد، وهي الإدغام والإخفاء والإظهار.
...
**الغرض:** نستخدم الوقف لتمثيل المفهوم العام للوقف، أما `waqf_mark` فتمثل العلامات المطبوعة التي ترشد إليه.
...
> الاسم `segment` يعني في مدونات الصرف القرآني الوحدة الصرفية، ويعني في واجهات الصوت توقيت الكلمة. لذلك لا يُحل الاسم وحده إلى شيء، ويُحل `word_segment` إلى هذا المدخل، ويُحل المعنى الصوتي إلى `word_timing`.
