...
- **`code`** معرف يستعمل في الكود والـAPI وقواعد البيانات. يشتق بقواعد الأقسام
  4 إلى 8 **بلا استثناء**. المهم فيه أن يبقى ثابتًا، لا أن يكون مألوفًا.
...
فالصورة المألوفة مهمة، لكن مكانها حيث يقرأ الناس، لا في عمود قاعدة بيانات.
...
وتجد `sughra` و`sagheer` وهما من أصل واحد. وما لا يطرد لا يصلح قاعدة.
