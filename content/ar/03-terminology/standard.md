...
- المدخل يجب أن يكون **بالحركات**، لأن الحركات القصيرة لا يمكن استنتاجها من
...
للتسمية أربع وظائف مطالبها متعارضة: معرف ثابت في الكود، واسم مألوف للقارئ،
ونقل دقيق للنطق، ومدخل للبحث. ولا يؤديها اسم واحد، فيفرد لكل وظيفة حقلها:
...
أربعة أضعاف `Nun Sakinah`، وأن `Meem Sakinah` تستعمل خمسة أضعاف `Mim Sakinah`.
