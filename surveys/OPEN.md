...
- *The tajwid rulings* (§3.7, §6.1) — A registry: `standards/terminology/registries/tajwid_rules.tsv`, generated from `standards/terminology/data/tajweed_engine_rules.json`, with `tajwid_ruling` as the classification over it. See the decision *The rules of tajwid are a registry, not entries*.
