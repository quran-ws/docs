...
| **دليل المصطلحات** | [المعيار](content/ar/03-terminology/standard.md) و[القاموس](content/ar/03-terminology/dictionary.md): اسم واحد لكل مفهوم، وتهجئة تشتق بدالة لا تختار، ومصدر يقرأ آليًا في [`standards/`](standards/terminology/)، و[مهارة وكيل](skills/quranic-terminology/) تفحص بها كودًا قائمًا. |
...
| **Terminology** | The [standard](content/en/03-terminology/standard.md) and [dictionary](content/en/03-terminology/dictionary.md): one name per concept, spellings derived by a function rather than chosen, a machine-readable source in [`standards/`](standards/terminology/), and an [agent skill](skills/quranic-terminology/) that audits a codebase against it. |
