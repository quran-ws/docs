...
كتبناه لأنفسنا أولًا: حتى تكون قراراتنا متسقة عبر المشاريع، ولا نعيد الجدال نفسه في كل مستودع جديد. ونشرناه للعموم لأن أكثر ما فيه ليس خاصًا بنا؛ فأي فريق يبني تطبيقًا قرآنيًا يواجه الأسئلة نفسها: هل نكتب `Ayah` أم `Verse`؟ متى يجوز تعديل نص مصحف منشور؟ كيف نُعلم المستخدمين بتصحيح في النص؟
...
المستودع في مرحلة التأسيس. **معيار المصطلحات** مسودة قيد الكتابة، وهو أكثر المحاور نضجًا حتى الآن؛ وبقية المحاور هيكل لم يُكتب بعد. لا شيء هنا مُعتمدًا بعد، ولا يُبنى عليه في مشروع قبل أن يُوسم `adopted`.
